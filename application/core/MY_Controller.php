...
class MY_Controller extends CI_Controller{
	...
	public function getMedia($access_token, $media_id){
		...
		$url = "https://api.weixin.qq.com/cgi-bin/media/get?".http_build_query($params);
		return $url;
	}
	
	/**
	 * @desc 获取公众号的全局唯一票据access token
	 * @author chenfei <chenfei@zhangyue.com>
	 * @version 2015-01-28 10:45:00
	 */
	public function getTokenUrl() {
		$params = array(
				'grant_type' => 'client_credential',
				'appid' => 'wxee4d6ea212701797', //公众号的唯一标识
				'secret' => '5598941e6da6aa07358c51b712d03927', //公众号的appsecret
		);
